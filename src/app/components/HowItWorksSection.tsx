...
const stepIcons = [ClipboardList, UtensilsCrossed, Bike];
const stepStyles = [
  { color: 'bg-primary/10 text-primary', border: 'border-primary/20' },
  { color: 'bg-secondary/10 text-secondary', border: 'border-secondary/20' },
  { color: 'bg-accent/10 text-amber-700', border: 'border-amber-200' },
];
    ...
    <section id="how-it-works" className="py-16 lg:py-20 bg-white">
      <div className="max-w-screen-2xl mx-auto px-4 lg:px-8 xl:px-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          {settings.howItWorksSteps.map((step, idx) => {
