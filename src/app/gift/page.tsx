        ...
        {status === 'success' ? (
          <div className="text-center py-8">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-8 max-w-sm mx-auto">
              You have successfully sent a <span className="font-800 text-[#C39B54]">£{Number(successAmount || price).toFixed(2)}</span> gift card to <span className="font-800 text-[#1E3B2B]">{successEmail}</span>. They will receive it in their wallet.
            </p>
            <button 
          ...
          <>
            ...
            {!user ? (
              <div className="text-center py-6 bg-gray-50 border border-dashed border-border rounded-2xl">
                <p className="text-sm text-muted-foreground font-600 mb-4">Please sign in to purchase and send gift cards.</p>
                <Link
              ...
              <form className="space-y-8" onSubmit={handleSubmit}>
                ...
                <div className="flex flex-col items-center gap-2 mt-4">
                  <p className="text-xs text-muted-foreground font-600">Secure checkout powered by Stripe</p>
