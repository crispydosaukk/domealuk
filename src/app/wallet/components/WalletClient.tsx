...
export default function WalletClient() {
    ...
    return (
      <div className="max-w-md mx-auto text-center py-12 px-6 bg-white rounded-3xl border border-border shadow-xl">
        ...
        <p className="text-muted-foreground text-sm leading-relaxed mb-8">
          Sign in to view your balance, claim gift cards, track referral rewards, and easily apply
  ...
  const getStatusStyle = (status: Transaction['status']) => {
    switch (status) {
      ...
      default:
        return {
          bg: 'bg-gray-50 text-gray-700 border-gray-150',
          icon: HelpCircle,
          label: 'Unknown',
        };
    }
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">
          Manage your credits, gifts, and loyalty rewards.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 relative overflow-hidden bg-gradient-to-br from-[#1E3B2B] via-[#244734] to-[#14281D] text-white rounded-3xl p-6 md:p-8 shadow-xl border border-white/5 flex flex-col justify-between min-h-[200px] group">
          ...
          <div className="flex justify-between items-start z-10">
            <div>
              <p className="text-xs font-850 uppercase tracking-widest text-[#C39B54] mb-1">
                Available Balance
              </p>
          ...
          <div className="mt-8 flex flex-wrap gap-4 items-center justify-between z-10 pt-4 border-t border-white/10">
            <span className="text-xs text-white/60 font-600 flex items-center gap-1.5">
              <Sparkles size={14} className="text-[#C39B54]" /> Use this balance directly at
              checkout!
            </span>
        ...
        <div className="bg-white rounded-3xl p-6 border border-border shadow-sm flex flex-col justify-between">
          <div>
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              Share your invite code with friends. Once they place their first order, you both get
              rewarded!
            </p>
          </div>

          <div className="mt-6 pt-4 border-t border-border">
            <p className="text-[10px] text-muted-foreground font-700 uppercase tracking-wider mb-1.5">
              Your Referral Code
            </p>
            <div className="flex items-center justify-between bg-gray-50 border border-border rounded-xl px-3 py-2">
              <span className="font-900 text-sm text-[#1E3B2B] tracking-widest">
                {referralCode}
              </span>
              <button
                onClick={() => {
          ...
          {filteredTransactions.length === 0 ? (
            <div className="p-12 text-center text-muted-foreground flex flex-col items-center justify-center gap-3">
              ...
              <p className="text-xs text-muted-foreground max-w-sm">
                When you earn referral credits, redeem gift cards, or spend your balance, your
            ...
            filteredTransactions.map((tx) => {
              ...
              const formattedDate = tx.createdAt?.toDate
                ? tx.createdAt.toDate().toLocaleString('en-GB', {
                    day: '2-digit',
                    month: 'short',
                    year: 'numeric',
                    hour: '2-digit',
                ...
                : tx.createdAt?.seconds
                  ? new Date(tx.createdAt.seconds * 1000).toLocaleString('en-GB', {
                      day: '2-digit',
                      month: 'short',
                      year: 'numeric',
                      hour: '2-digit',
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap items-center gap-2 mt-1">
                        ...
                        <span
                          className={`inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded text-[9px] font-800 border ${statusInfo.bg}`}
                        >
                  ...
                  <div className="text-right">
                    <span
                      className={`text-base font-900 tabular-nums ${
