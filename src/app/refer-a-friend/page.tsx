          ...
          <div className="p-8 md:p-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="w-16 h-16 bg-blue-50 text-primary font-900 text-2xl rounded-2xl flex items-center justify-center mx-auto mb-4 border border-blue-100 shadow-sm">
                  1
                </div>
                <h3 className="font-800 text-lg mb-2 text-foreground">
                  {settings.referralStep1Title}
                </h3>
                <p className="text-muted-foreground text-sm whitespace-pre-line">
                  {settings.referralStep1Desc}
                </p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-blue-50 text-primary font-900 text-2xl rounded-2xl flex items-center justify-center mx-auto mb-4 border border-blue-100 shadow-sm">
                ...
                <h3 className="font-800 text-lg mb-2 text-foreground">
                  {settings.referralStep2Title}
                </h3>
                <p className="text-muted-foreground text-sm whitespace-pre-line">
                  {settings.referralStep2Desc.replace(
                    /\{amount\}/g,
                    settings.referralAmount.toString()
                  )}
                </p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-[#C39B54]/20 text-[#1E3B2B] font-900 text-2xl rounded-2xl flex items-center justify-center mx-auto mb-4 border border-[#C39B54]/30 shadow-sm">
                  3
                </div>
                <h3 className="font-800 text-lg mb-2 text-foreground">
                  {settings.referralStep3Title}
                </h3>
                <p className="text-muted-foreground text-sm whitespace-pre-line">
                  {settings.referralStep3Desc.replace(
                    /\{amount\}/g,
                    settings.referralAmount.toString()
                  )}
                </p>
            ...
            {!user ? (
              <div className="mt-12 text-center">
                <Link
                  ...
                  className="inline-block bg-[#C39B54] text-white font-800 px-8 py-4 rounded-xl hover:bg-[#a17e41] transition-all shadow-lg shadow-yellow-900/20"
                >
              ...
              <div className="mt-12 text-center">
                <p className="text-sm font-800 text-muted-foreground mb-3">
                ...
                <div className="inline-flex flex-col sm:flex-row items-center gap-3 bg-gray-50 p-2 sm:pr-2 rounded-xl border border-border shadow-sm">
                  <span className="text-2xl font-900 text-foreground px-6 py-2 select-all tracking-widest">
